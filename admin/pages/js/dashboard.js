...
export const dashboardFn = () => {
    ...
    let recentStudent=users.slice(0,5)
    let recentCourse=courses.slice(0,5)
    //global variable
    ...
    let recentStudentEl=dashboardEl.querySelector(".recent-students")
    let recentCourseEl=dashboardEl.querySelector(".recent-courses")

     //create chart code
    var chart = new ApexCharts(areaChart, options);
    chart.render();
    var chart = new ApexCharts(columnChart, options1);
    chart.render();

    //recent student code
    recentStudent.forEach((item,index)=>{
        // console.log(item)
        recentStudentEl.innerHTML +=`
    ...
    //recent course code
    recentCourse.forEach((item,index)=>{
